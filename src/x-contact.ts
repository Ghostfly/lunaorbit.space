      ...
      <div class="container px-5 py-24 mx-auto flex">
        <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
          ...
          >
            ...
            <p class="text-md mt-3">${msg('Find us on')} <a href="http://t.me/${config.telegram}" target="_blank" rel="noopener" title="Telegram" class="text-gray-500 hover:text-indigo-500">Telegram</a> ${msg('or')} <a class="text-gray-500 hover:text-indigo-500" href="https://twitter.com/${config.twitter}" target="_blank" rel="noopener" title="Twitter">Twitter.</p>
        </form>
        </div>
      </div>
    </section>
