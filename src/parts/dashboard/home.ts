      ...
      <div class="cta-editor flex flex-wrap gap-2">
        ...
        <div class="relative">
          ...
          <input
            ...
            name="${cta.id}-cta-link-href"
            id="${cta.id}-cta-link-href"
            type="text"
            .value=${cta.href}
            class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:ring-2 focus:bg-transparent focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
          />
          ...
          <div class="strength-block flex justify-center gap-2 m-4">
            <div class="relative">
              ...
              <input
                ...
                name="${strength.id}-title"
                id="${strength.id}-title"
                type="text"
              ...
              ? html`
                  <div class="relative">
                    ...
                    <input
                      ...
                      name="${strength.id}-link-name"
                      id="${strength.id}-link-name"
                      type="text"
                      .value=${strength.link.name}
                      class="bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:ring-2 focus:bg-transparent focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                    />
                  </div>
                  <div class="relative w-full">
                    <label
                      for="${strength.id}-link-href"
                      class="leading-7 text-sm text-gray-600"
                      >URL</label
                    >
                    <input
                      ...
                      name="${strength.id}-link-"
                      id="${strength.id}-link-"
                      type="text"
                      .value=${strength.link.href}
                      class="bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:ring-2 focus:bg-transparent focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out w-full"
                    />
                  </div>
                `
              : ''}
