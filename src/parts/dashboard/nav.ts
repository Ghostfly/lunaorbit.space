  ...
  render(): TemplateResult {
    return html`
      <div class="${this.disabled ? 'pointer-events-none opacity-50' : ''}">
        <div class="flex flex-col items-center mt-3 ">
          ${this.address
            ? html`
                <img
                  ...
                  src="https://avatars.dicebear.com/api/jdenticon/${this
                    .address}.svg"
                />
              `
            : html``}
          <a
            class="flex items-center justify-center w-12 h-12 mt-2 rounded ${this
              .page === DashboardPages.strengths
              ? 'text-indigo-100 bg-blue-700'
              : 'hover:bg-blue-700 hover:text-white'}"
            href="${AdminNav.MainPathPrefix}/${DashboardPages.strengths}"
            title="${msg('Strengths')}"
          >
            <svg
          ...
          <a
            class="flex items-center justify-center w-12 h-12 mt-2 rounded ${this
              .page === DashboardPages.tools
              ? 'text-indigo-100 bg-blue-700'
              : 'hover:bg-blue-700 hover:text-white'}"
            href="${AdminNav.MainPathPrefix}/${DashboardPages.tools}"
            title="${msg('Tools')}"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            class="flex items-center justify-center w-12 h-12 mt-2 rounded ${this
              .page === DashboardPages.howTo
              ? 'text-indigo-100 bg-blue-700'
              : 'hover:bg-blue-700 hover:text-white'}"
            href="${AdminNav.MainPathPrefix}/${DashboardPages.howTo}"
            title="${msg('How to')}"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            class="flex items-center justify-center w-12 h-12 mt-2 rounded ${this
              ...
              ? 'text-indigo-100 bg-blue-700'
              : 'hover:bg-blue-700 hover:text-white'}"
            href="${AdminNav.MainPathPrefix}/${DashboardPages.menus}"
            title="${msg('Menus')}"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          class="flex items-center justify-center w-12 h-12 mt-2 rounded ${this
            .page === DashboardPages.assets
            ? 'text-indigo-100 bg-blue-700'
            : 'hover:bg-blue-700 hover:text-white'}"
          href="${AdminNav.MainPathPrefix}/${DashboardPages.assets}"
          title="${msg('Assets')}"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          class="flex items-center justify-center w-12 h-12 mt-2 rounded ${this
            ...
            ? 'text-indigo-100 bg-blue-700'
            : 'hover:bg-blue-700 hover:text-white'}"
          href="${AdminNav.MainPathPrefix}/${DashboardPages.settings}"
          title="${msg('Settings')}"
        >
          <svg
