...
import { performFeatureDetect } from './components/browser-happy';

performFeatureDetect();
...
export class LunaOrbit extends LitElement {
  ...
  static APIDelegationsURL = 'https://lcd.terra.dev/staking/validators/terravaloper1p94a6vwl9dkd98cyrlmzf6ydjdgfvamyhu33fa/delegations';
